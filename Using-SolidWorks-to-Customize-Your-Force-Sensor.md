...
**03. To adjust the thickness of the cantilever beam (and consequently shift the cantilever base by the same amount):**
...
**04. To change whether or not there is a hole at the free end of the cantilever beam:**
...
**05. To adjust the thickness of the cantilever base:**
...
**06. To adjust the depth of the conductive traces:**
...
$$ \sf \text{new resistance} = \text{old resistance} \ \! \cdot \dfrac{\: \, \text{old depth}}{\text{new depth}} $$

Only use the formula for wire-like conductive traces. Do not use It for electrical terminals / contact pads.

**07. To change whether or not there is a reference set of conductive traces:**
...
**08. To change whether or not there are recesses/slots for crocodile clips:**
    
 1. [In the left pane, open the context menu for Cut-Extrude0](Using-SolidWorks-to-Customize-Your-Force-Sensor/08/1.png), noted to be: \
